---
title: "Soforthilfe – Erste Unterstützung für dich"
description: "Kleine Übungen und Impulse für belastende Momente."
...
<section class="vorteile-container ifge-tuerkis">
  <div class="vorteile-grid" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 2rem; margin-top: 2rem;">
    <div class="vorteil-box">
      <img src="/img/icon/start1.png" alt="Atemübung" class="vorteil-icon" />
      <h10>Atemübung</h10>
      <p>Atme tief in den Bauch ein, zähle bis vier. Halte den Atem kurz an, spüre die Ruhe. Atme langsam und vollständig aus. Wiederhole diese Übung fünfmal, um deinen Körper zu beruhigen und den Stresspegel zu senken.</p>
    </div>
    <div class="vorteil-box">
      <img src="/img/icon/start1.png" alt="Liste der angenehmen Dinge" class="vorteil-icon" />
      <h10>Liste der angenehmen Dinge</h10>
      <p>Notiere auf einem Zettel fünf Dinge, die dir Freude bereiten – auch Kleinigkeiten zählen. Lies die Liste durch, wenn du dich belastet fühlst, und erlaube dir einen Moment des Lächelns.</p>
    </div>
  </div>

  <div class="vorteile-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem; margin-top: 2rem;">
    <div class="vorteil-box">
      <img src="/img/icon/start1.png" alt="Mini-Reflexion" class="vorteil-icon" />
      <h10>Mini-Reflexion</h10>
      <p>Setze dich für einen Moment hin, schließe die Augen und frage dich: „Was hat mir in der Vergangenheit in ähnlichen Situationen geholfen?“ Notiere deine Gedanken und erkenne deine eigenen Ressourcen.</p>
    </div>
    <div class="vorteil-box">
      <img src="/img/icon/start1.png" alt="Körperübung" class="vorteil-icon" />
      <h10>Körperübung</h10>
      <p>Lege eine Hand aufs Herz, spüre den Herzschlag und die Wärme. Konzentriere dich auf deinen Atem und stelle dir vor, wie du mit jedem Ausatmen Anspannung loslässt.</p>
    </div>
    <div class="vorteil-box">
      <img src="/img/icon/start1.png" alt="Positivanker" class="vorteil-icon" />
      <h10>Positivanker</h10>
