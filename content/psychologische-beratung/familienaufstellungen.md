...
rich_faq:
    ...
    -   frage: "Wie lange dauert eine Familienaufstellung?"
        antwort: "Eine Familienaufstellung dauert meist ein oder zwei Tage und es kommen mehrere Personen in einer Gruppe zusammen, die sich davor im Normalfall noch nicht gesehen haben, also auch nichts über die jeweiligen Probleme bzw. Familienhintergründe wissen. Unter der Anleitung des Aufstellungsleiters wählt man aus dieser Gruppe Personen Stellvertreter/innen aus. Der Aufstellungsleiter gibt je nach Thema vor, welche Personen aufgestellt werden sollen, z.B. die Mutter oder der Ehepartner etc."
    -   frage: "Was kann eine Familienaufstellung bewirken?"
        antwort: "Durch Familienaufstellungen erfährt man oft ein hohes Gefühl der Verbundenheit – man bekommt eine Ahnung davon, wie sehr man mit seiner Familie auf einer anderen, unbewussten Ebene verbunden ist, auch mit Personen, die einem im realen Leben vielleicht gar nicht nahe stehen oder die man lebend nicht mehr kennengelernt hat. Auf dieser unbewussten Ebene wirken oft ganz andere Mechanismen als auf der bewussten Ebene, die „Seele“ möchte aus Verbundenheit mit der Familie oft etwas ganz anderes als man es im realen Leben anstrebt."
    -   frage: "Was ist ein Morphogenesetisches Feld?"
    ...
    -   frage: "Ändern Familienaufstellungen etwas an der Geschichte?"
        antwort: "Familienaufstellungen ändern nichts an der Geschichte, helfen uns aber neue Erkenntnisse und Sichtweisen in alte, oftmals krankmachende Muster zu integrieren. Durch die neugewonnene Sichtweise, die dem Erlebten hin­zu­ge­fügt wird, öffnet sich der Blick und unser Herz, sodass Lösungen beginnen können und neue wirksame Realitäten geschaffen werden können. Durch das Bewusstwerden über die Glaubenssätze, die in der eigenen Familie bestehen, können diese letztlich verändert und Ziele gefunden werden, die Ihrem persönlichen Fortkommen dienlich sind. Diese neuen Realitäten und Zielvorstellungen können besonders nachhaltig in einer anschließenden Glaubenssatzaufstellung erarbeitet werden."
    -   frage: "Soll ich vor einer Familienaufstellung ein Einzelgespräch in Anspruch nehmen?"
        antwort: "Es empfiehlt sich, vor einer Familien­auf­stel­lung ein Erstgespräch in Anspruch zu nehmen, um die Beweg­gründe zu klären und Vorinformationen einzuholen."    
    -   frage: "Wie kann eine Familienaufstellung für mich nützlich sein?"
        antwort: "Familienstellen hat nicht nur den Einzelnen, sondern das gesamte Familiensystem im Blick und ermöglicht dadurch ganz neue Einblicke sowie Lösungen und kann bei Themen helfen, bei denen man schon lange nach einer positiven Veränderung sucht. Erst wenn gesehen, gehört und anerkannt wird, was in der Größe der Familienseele wirkt, können Lösungen beginnen."
    -   frage: "Ist nach einer Familienaufstellung wieder alles gut?"
        antwort: "Familienaufstellungen sollen nichts beschönigen oder eine Scheinharmonie herstellen, vielmehr geht es um Anerkennung was im Gesamtenfamiliensystem wirkt.Es geht dabei keineswegs um Rationalisierung, Idealisierung oder Schönfärben der oft­mals schmerzhaften Erfahrungen.Doch gerade dann, wenn wir uns in schweren Lebenssituationen befinden, wird unser Blick eng und alles in uns scheint still zu stehen. Meistens drehen sich unsere Gedanken im Kreis und wir finden keine Lösung. Die Frage, wo solche Gefühle und Sorgenkarusselle – die für uns oft kaum verständlich sind – herkommen und wofür diese im eigenen Leben stehen, kann durch Familienaufstellungen unnachahmlich beantwortet werden. Viele unserer Emotionen, Handlungsweisen und Verhaltensmuster haben mit dem zu tun, was in unserer Familiengeschichte heimlich wirkt. Die Heimlichkeit, von der wir in der systemischen Arbeit nach Hellinger sprechen, bezieht sich nicht zwangsläufig auf klassische Geheimnisse, sondern viel eher auf die heimliche Liebe und Loyalität zu Mitgliedern aus unserer Familie, welche zumeist ein schweres Schicksal hatten und vergessen oder ausgeklammert wurden. Dies verletzt jedoch eine existenzielle Grundregel jeder Familie: Jeder hat das gleiche Recht auf Zugehörigkeit."
    -   frage: "Was sind Glaubensatzaufstellungen?"
        antwort: "Während es in der klassischen Familienaufstellung vor allem darum geht, die eigenen destruktiven Musters zu erkennen und Verständnis für die persönliche Familiengeschichte – also das eigene Herkunftssystem – zu entwickeln, damit es schließlich für Sie gut weitergehen kann, arbeite ich in der Glaubenssatz-Aufstellung vorrangig gegenwartsbezogen.Das bedeutet, dass eine Familienaufstellung als Vorbereitung in den meisten Fällen sehr zu empfehlen ist, bevor Sie einen Schritt weiter gehen und sich damit beschäftigen können, welche Ziele für Ihre Weiterentwicklung und Ihre Bedürfnisse dienlich sind."
    -   frage: "Wie können in der Glaubensatzaustellung neue Realitäten gelingen?"
        antwort: "Ein praktisches Beispiel für den Unterschied zwischen einfacher Umkehr und kraftvoller neuer Realität zeigt das Anliegen von Klientinnen, die das Gefühl haben, immer wieder zu scheitern. Wenn der begrenzende und destruktive Glaubenssatz dieser Klientinnen lautet „Ich bin nicht erfolgreich“, so wäre die schlichte Umkehr „Ich bin jetzt erfolgreich“ zu kurz gegriffen. Vielleicht bemerken Sie schon, dass hier nur ein Wort verändert wurde und sich die Klientinnen mit diesem Ziel weiterhin im Problemsystem befinden würden."  
    -   frage: "Was unterscheidet Familienaufstellungen von anderen Methoden?"
        antwort: "In der systemischen Sichtweise geht man davon aus, dass der Ursprung fast jedes Problems in der Familie liegt. Familienaufstellungen machen mehr Lösungen möglich, da sie nicht nur bei dem Klienten/der Klientin selber ansetzen, sondern an dem gesamten Familiensystem, zu dem insbesondere die Eltern, Großeltern, Urgroßeltern, Kinder, Geschwister der Eltern, ehemalige und jetzige Partner/innen aber auch Schicksalsgemeinschaften gehören. Schicksalsgemeinschaften bilden sich nicht nur innerhalb eines Familiensystems, sondern erfassen auch weitere Systeme wie zwischen Tätern und Opfern im Rahmen von Kriegen, Holocaust oder ähnlich existentiell aneinander gebundenen Mitgliedern. So gehört, wenn es einen Mörder oder z.B. Unfalllenker in unserem System gibt, automatisch auch das zugehörige Opfer zu unserem System, auch wenn es kein direktes Mitglied unserer Familie ist."
    -   frage: "Was ist eine Familienaufstellung und wie läuft diese ab?"
        antwort: "Bei Familienaufstellungen kann ein beliebiges Thema aufgestellt werden, das belastend wirkt – egal ob es aus dem privaten oder beruflichen Bereich kommt. Häufig kommen Klient/innen mit folgenden Anliegen: körperliche Erkrankungen, Paar- und Beziehungsschwierigkeiten, Wiederholung eines immer gleichen Musters, das Gefühl, nicht das eigene Leben zu leben oder Schwierigkeiten im Berufsleben.Eine Familienaufstellung dauert meist ein oder zwei Tage und es kommen mehrere Personen in einer Gruppe zusammen, die sich davor im Normalfall noch nicht gesehen haben, also auch nichts über die jeweiligen Probleme bzw. Familienhintergründe wissen. Unter der Anleitung des Aufstellungsleiters wählt man aus dieser Gruppe Personen Stellvertreter/innen aus. Der Aufstellungsleiter gibt je nach Thema vor, welche Personen aufgestellt werden sollen, z.B. die Mutter oder der Ehepartner etc. Und dann geschieht das Spannende, das man wohl selbst einmal erlebt haben muss: als Stellvertreter/in fühlt man plötzlich, wie die reale Person, die man vertritt, zu diesem Thema in dieser spezifischen Konstellation, steht. So kann es passieren, dass man plötzlich eine enorme Wut empfindet oder die Beine schwach werden und man sich hinlegen muss – die Emotionen sind meist intensiv spürbar und man wird als Stellvertreter/in einfach von ihnen in Besitz genommen."
    -   frage: "Was kann eine Familienaufstellung bewirken?"
        antwort: "Durch Familienaufstellungen erfährt man oft ein hohes Gefühl der Verbundenheit – man bekommt eine Ahnung davon, wie sehr man mit seiner Familie auf einer anderen, unbewussten Ebene verbunden ist, auch mit Personen, die einem im realen Leben vielleicht gar nicht nahe stehen oder die man lebend nicht mehr kennengelernt hat. Auf dieser unbewussten Ebene wirken oft ganz andere Mechanismen als auf der bewussten Ebene, die „Seele“ möchte aus Verbundenheit mit der Familie oft etwas ganz anderes als man es im realen Leben anstrebt."
    -   frage: "Was kann eine Familienaufstellung verändern?"
...
Jeder Mensch strebt ein glückliches, zufriedenes und erfülltes Leben an. Doch manchmal kommen wir entlang unseres Lebensweges an Punkte, an denen uns vergangene Erlebnisse, negative Gedanken und belastende Ängste blockieren. Nicht immer sind uns diese Blockaden bewusst. Sie können sich auch indirekt in steigender Anspannung, Unzufriedenheit und [Konflikten](https://www.ifge.at/blog/konflikte/) in Berufs- oder Privatleben äußern. Der Ursprung von Blockaden, Barrieren und Belastungen ist nicht selten in der individuellen Herkunft zu finden. Kein Wunder. Denn Familien sind das erste soziale System, welches wir als Menschen kennenlernen. Damit prägt uns die Familie positiv, aber eben auch negativ. 
...
##  Was Familienaufstellung (nicht) kann.
...
Vergangenheit ist Vergangenheit. Und damit nicht veränderbar. Systematische und professionell begleitete Familienaufstellung kann aber unterstützen, mit der Vergangenheit Frieden zu schließen. Versöhnung mit Wurzeln und Herkunft bereichert wiederum unsere Zukunft. Ganz einfach, weil Themen aufgearbeitet und Zusammenhänge verstanden werden und damit mehr Bewusstsein geschaffen wird.

Familienaufstellung kann keine Familie ändern. Sehr wohl aber den Blick auf das System Familie und auf uns selbst. Häufig ist uns gar nicht bewusst, wie stark wir unser Verhalten an familiären Mustern, Idealen und Erwartungen ausrichten, während wir eigene Bedürfnisse hintenanstellen. Ein Verhalten, welches viel Konfliktpotenzial birgt. Familienaufstellung schärft den Blick für uns selbst, unsere Rolle in einer Familie und das große Ganze. 

Idealisierung. Runterspielen. Schönreden. Damit hat professionelle Familienaufstellung nichts zu tun.  Ganz im Gegenteil. Viele Menschen haben familiäre Traumata lange genug verdrängt, manchmal bewusst, häufig auch unbewusst. Die Folge: Negative Gefühle, Sorgenkarusselle und Verhaltensweisen nehmen weiter ihren Lauf und hemmen uns. Familienaufstellung konfrontiert bewusst mit vergangenen Wunden, schmerzhaften Erinnerungen und familiären Schicksalsschlägen. Nur so können Lösungswege für mehr Zufriedenheit, Ausgeglichenheit und inneren Frieden erarbeitet werden.
...
Den Blick auf das große Ganze, also auf das vielschichtige System Familie, braucht es, um persönliche Empfindungen, kollektive Dynamiken und soziale Konflikte zu verstehen. 
