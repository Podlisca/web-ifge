...
Unterschiedliche systemische Zugänge ermöglichen – neben klassischen [Familienaufstellungen](www.ifge.at) in der Gruppe –, auch in Einzelsitzungen eine breite Übersicht über Ihre [Glaubenssätze](www.ifge.at) und bekannten Handlungsmuster, welche Sie führen. In der hypnosystemischen Beratung achte ich zum Beispiel darauf, dass Sie Ihre Stärken und Fähigkeiten ganz bewusst erkennen und diese fokussiert – aber auch wohldosiert – für Ihre Lösungen einsetzen können, um neue [wirksame Realitäten zu erschaffen](www.ifge.at).
...
{{% /small  %}}
{{% large %}}
Systemische Beratung bedeutet in meinem Verständnis nicht – wie so oft anders in Aussicht gestellt – dass mit einer großen Familienaufstellung in der Gruppe jedes einzelne belastende Thema von Klient\*innen aufgearbeitet und für immer dauerhaft gelöst werden kann. Die [Philosophie](www.ifge.at), die bei mir am Institut für ganzheitliches Erleben gelebt wird, ist viel eher die Lösung der kleinen, sicheren Schritte. Diese scheinen auf den ersten Blick möglicherweise nicht als so gewichtig wie die Lösungen, die in Gruppenaufstellungen sichtbar gemacht und bearbeitet werden, helfen aber ebenso durch das kontinuierliche innere Erleben, sichtbar Gewordenes nachhaltig in persönliche Lösungskonzepte zu integrieren. Systemische Einzelstunden festigen dazu oft den in der Gruppe erzielten Aufstellungserfolg.

In Einzelsitzungen ist es überdies auch möglich, sich besonders viel Zeit für die Auswirkungen und persönlichen Folgen der in Gruppenaufstellungen sichtbar gewordenen Verstrickungen zu nehmen und Ihre [neue Realität](www.ifge.at) zu erschaffen. Ein bekannter Lösungssatz in der [klassischen Familienaufstellung](www.ifge.at) ist die Bitte der KlientInnen, dass jenes Familienmitglied, dem wir mit dem Lösen unseres Problems unähnlich werden, freundlich auf uns schauen möge, wenn es für uns anders und gut weitergehen darf. Diese eingeholte Erlaubnis – dieser freundliche Blick – am Ende einer Aufstellung nach Hellinger stellt den Beginn der [Glaubenssatzaufstellung](www.ifge.at) dar. Denn wenn es für Sie anders und gut weitergehen darf, wie sieht dieses „anders“ und „gut“ in Ihrem persönlichen Fall aus? Hier setzt das Finden Ihres Zieles – also Ihrer neuen Realität – an. Was ist Ihr Bedürfnis? Was benötigen Sie?
{{% /large %}}
{{% /box %}}

Mir ist dabei wichtig, zu betonen, dass das Ziel, das Sie für sich definieren, keine einfache Umkehr darstellt, sondern viel eher eine [wirksame neue Realität](www.ifge.at) entsteht. 
...
{{% box %}}
{{% small  %}}
{{< figure src="/img/img1.jpg" title="Sichtbar machen, was seit mehreren Generationen im Familiensystem wirkt" >}}
{{% /small  %}}
{{% large %}}
...
{{% /large %}}
{{% small  %}}
{{< figure src="/img/img1.jpg" title="Zusammenhänge im Raum der Zeit erkennen" >}}
{{% /small  %}}
{{% /box %}}
